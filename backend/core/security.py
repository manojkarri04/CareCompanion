...
def check_token(f):
    ...
    def wrap(*args, **kwargs):
        ...
        try:
            ...
            decoded_token = None
            # Try decoding with raw secret string first
            try:
                ...
                # Fallback to base64-decoded secret if raw secret fails
                try:
                    ...
                    print("🔥 SECURITY ALERT: InvalidSignatureError - SUPABASE_JWT_SECRET in .env does not match Supabase Dashboard JWT Secret.")
            ...
            # Return a distinct error code so the frontend can trigger re-login.
