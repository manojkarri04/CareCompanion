...
📖 CareCompanion AI
🩺 Overview
CareCompanion AI is a patient-focused health assistance system designed in Figma. The aim of the project is to educate patients and ensure they never miss an opportunity for recovery from any health issue they are suffering from.
...
⚡ (Future Development) React, TailwindCSS, and AI integrations (ChatGPT API, YouTube Data API, Google Maps API)
